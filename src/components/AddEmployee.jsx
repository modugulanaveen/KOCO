...
export default function AddEmployee({ employees, setEmployees, setPage, setCompany }) {
  ...
  // Function to handle CSV data import from CSVUpload component
        ...
        <div className="income-table">
          ...
          <div className="table-actions">
            <div className="left-action">
              <button type="button" className="link-btn" onClick={addEarning}>
                + Add Earnings
              </button>
            </div>
            <div className="right-action">
              <button type="button" className="link-btn" onClick={addDeduction}>
                + Add Deductions
              </button>
            </div>
          </div>
